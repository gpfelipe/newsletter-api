...
function extractCryptoTags(text) {
    const tags = ["AI16Z","ANON","BEAM","BNB","BTC","COOKIE","DEEP","DOG","ENA","ETH","GRIFFAIN","KAMINO","LDO","NEAR","NYAN","ONDO","PYTH","PRIME","PROMPT","RON","SEI","SUI","SOL","TAO","VIRTUAL","VVV"];
...
app.get('/news', async (req, res) => {
    try {
        const [messariData, coindeskData] = await Promise.all([
            axios.get('https://messari.io/news'),
